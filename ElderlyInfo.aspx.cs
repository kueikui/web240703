        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)//長者詳細資料
        {
            ...
            if (Session["LoginType"] == "System"){
                if (e.CommandName == "Details")
                {
                    ...
                    //eGender_list.Text = eGenderCell.Text;
                    string dateString1 = selectedRow.Cells[5].Text;
                    DateTime birthDate1;
                    if (DateTime.TryParseExact(dateString1, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out birthDate1))
                    {
                        eBirth_Text.Text = birthDate1.ToString("yyyy-MM-dd");
                    }


                    //eBirth_Text.Text = Convert.ToDateTime(selectedRow.Cells[4].Text).ToString("yyyy-MM-dd");
                    ...
                    string dateString2 = selectedRow.Cells[11].Text;
                    DateTime birthDate2;
                    if (DateTime.TryParseExact(dateString2, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out birthDate2))
                    {
                        eCreateFile_Text.Text = birthDate2.ToString("yyyy-MM-dd");
                    }
                    //eCreateFile_Text.Text = Convert.ToDateTime(selectedRow.Cells[10].Text).ToString("yyyy-MM-dd");
            ...
            else if (Session["LoginType"] == "Home")
            {
                ...
                if (e.CommandName == "Details")
                {
                    ...
                    if (DateTime.TryParseExact(dateString1, "yyyy-MM-dd", CultureInfo.InvariantCulture, DateTimeStyles.None, out birthDate1))
                    {
                        eBirth_Text.Text = birthDate1.ToString("yyyy-MM-dd");//HomeElder.heBirth as 長者生日
                    }
